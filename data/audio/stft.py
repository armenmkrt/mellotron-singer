...
from data.audio.audio_processing import dynamic_range_compression
from data.audio.audio_processing import dynamic_range_decompression
from data.audio.audio_processing import window_sumsquare
...
class TacotronSTFT(torch.nn.Module):
    ...
    def mel_spectrogram(self, y, return_energy: bool = False):
