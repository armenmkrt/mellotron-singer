...
from data.text import text_to_sequence, get_arpabet, cmudict


CMUDICT_PATH = "/home/podcastle/Documents/mellotron-singer/data/cmu_dictionary"
...
def event2text(events, convert_stress, cmudict=None):
    ...
    text_encoded = text_to_sequence(text_clean, ['english_cleaners'])
